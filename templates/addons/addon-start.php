...
<div class="wc-pao-addon-container mwbtesting-1-1 mwbtesting2 <?php echo $required ? 'wc-pao-required-addon' : ''; ?> wc-pao-addon wc-pao-addon-<?php echo esc_attr( sanitize_title( $name ) ); ?>" data-product-name="<?php echo esc_attr( $product_title ); ?>">
